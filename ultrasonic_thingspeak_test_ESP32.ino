...
String apiKey = "872SUOJKVZ8NAVZ9"; // write your "Write API key"
const char* ssid = "moto g82 5G_3701"; // write your "wifi name"
const char* password = "123456789"; // write your "wifi password"
